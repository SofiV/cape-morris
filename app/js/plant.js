...
function scaleToWindow() {
    if ($('.plant-canvas').innerWidth > $('.plant-canvas').innerHeight) {
        canvasContainerDiv.style.height = $('.plant-canvas').innerHeight * canvRatio + "px";
        canvasContainerDiv.style.width = canvasContainerDiv.style.height;
    } else {
        canvasContainerDiv.style.width = $('.plant-canvas').innerWidth * canvRatio + "px";
...
function Segment(plant, parentSegment, basePoint1, basePoint2) {
    ...
    //skins
    this.skins = [];
    this.skins.push(addSk([this.ptE1.id, this.ptE2.id, this.ptB2.id, this.ptB1.id], "#93b7ac"));
}
...
function renderLeaf(plant, leafSpan) {
    ...
    ctx.lineJoin = "round";
    ctx.lineCap = "round";
    ctx.strokeStyle = "#5d8377";
    ctx.fillStyle = "#5c8277";
